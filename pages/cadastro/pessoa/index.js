  ...
  return (
    <Layout loading={loading}>
      <ThemeProvider theme={{ mode: 'user' }}>
        <S.PageContainer>
          <B.Row>
            <S.BgCol lg="4"></S.BgCol>
            <B.Col lg="8">
              <S.ContentWrapper>
                <S.H3>Preencha seus dados</S.H3>
                <S.P>
                  Comece a preencher o seu cadastro em nossa plataforma nos
                  informando os seus dados pessoais para criação da conta.
                </S.P>
                {feedbackMessage.show && (
                  <Alert message={feedbackMessage.message} type="error" />
                )}
                <Formik
                  initialValues={{
                    name: '',
                    communityCode: (props.query && props.query.code) || '',
                    cpf: '',
                    email: '',
                    emailConfirmation: '',
                    accept: false,
                      ...
                      <S.CustomForm hide={step !== 1}>
                        ...
                        <S.Label width="33%">
                          ...
                          <S.CustomField
                            ...
                            name="communityCode"
                            placeholder="Insira o código da sua comunidade"
                          />
                          {errors.communityCode && touched.communityCode ? (
                            <S.Error>{errors.communityCode}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.Label width="33%">
                          <legend>CPF</legend>
                        ...
                        <S.Label width="33%">
                          ...
                          {errors.zipCode && touched.zipCode ? (
                            <S.Error>{errors.zipCode}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.Label width="33%">
                          <legend>País</legend>
                          ...
                          {errors.country && touched.country ? (
                            <S.Error>{errors.country}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.Label width="33%">
                        ...
                        <S.Label width="33%">
                          ...
                          {errors.neighborhood && touched.neighborhood ? (
                            <S.Error>{errors.neighborhood}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.Label width="35%">
                          ...
                          />
                          {errors.number && touched.complement ? (
                            <S.Error>{errors.complement}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.Label width="65%">
                        ...
                        <S.Label width="50%">
                          ...
                          touched.emailConfirmation ? (
                              <S.Error>{errors.emailConfirmation}</S.Error>
                            ) : null}
                        </S.Label>
                        <S.Label width="50%">
                          <legend>Senha*</legend>
                      ...
                      <S.CustomForm hide={step !== 2}>
                        <S.Label width="50%">
                          ...
                          <S.CustomSelect
                            ...
                            options={relations}
                            value={relations.find(
                              (option) =>
                                option.value === values.communityRelation
                            )}
                            onChange={(e, data) =>
                              setFieldValue(data.name, e.value)
                            }
                          />
                          {errors.communityRelation &&
                          touched.communityRelation ? (
                              <S.Error>{errors.communityRelation}</S.Error>
                            ) : null}
                        </S.Label>
                        <S.Label width="50%">
                          ...
                          {errors.occupation && touched.occupation ? (
                            <S.Error>{errors.occupation}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.Label>
                          <legend>
                            Nos diga se você tem urgência em algum mantimento:
                          </legend>
                          <S.CustomField
                            name="urgencies"
                            placeholder="Escreva aqui"
                          />
                          {errors.urgencies && touched.urgencies ? (
                            <S.Error>{errors.urgencies}</S.Error>
                          ) : null}
                        </S.Label>
                          ...
                          <div>
                            <label>
                              <input
                                type="radio"
                                value="true"
                                checked={values.specialNeeds.value}
                                name="specialNeeds.value"
                                onChange={() =>
                                  setFieldValue('specialNeeds.value', true)
                                }
                              />{' '}
                              Sim
                            </label>
                        ...
                        <S.Label width="60%">
                          ...
                          <S.CustomField
                            disabled={!values.specialNeeds.value}
                            name="specialNeeds.description"
                            placeholder="Escreva aqui"
                          />
                          {errors.specialNeeds && touched.specialNeeds ? (
                            <S.Error>{errors.specialNeeds}</S.Error>
                          ) : null}
                        </S.Label>
                        <S.CustomFieldSet width="40%">
                          ...
                          <div>
                            <label>
                              <input
                                type="radio"
                                value="true"
                                checked={values.controlledMedication.value}
                                name="controlledMedication.value"
                                onChange={() =>
                                  setFieldValue(
                                    'controlledMedication.value',
                                    true
                                  )
                                }
                              />{' '}
                            ...
                            <label>
                              <input
                                ...
                                onChange={() => {
                                  ...
                                  setFieldValue(
                                    'controlledMedication.description',
                                    ''
                                  )
                                }}
                              />{' '}
                        ...
                        <S.Label width="60%">
                          ...
                          <S.CustomField
                            disabled={!values.controlledMedication.value}
                            name="controlledMedication.description"
                            placeholder="Escreva aqui"
                          />
                        ...
                        <S.CheckBoxLabel>
                          ...
                          Li e aceito os{' '}
                          <S.TermsLink onClick={handleModal}>
                            Termos de Uso
                          </S.TermsLink>
                        </S.CheckBoxLabel>
                        <S.ButtonsWrapper>
                          ...
                          <E.CustomButton type="submit" color="primary">
                            Cadastrar
                          </E.CustomButton>
                        </S.ButtonsWrapper>
                      </S.CustomForm>
